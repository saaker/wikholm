    ...
    return (
      <div className="bg-footer-bg rounded-xl overflow-hidden">
        <div className="px-6 py-8">
          <div className="grid md:grid-cols-[1fr_auto_1.4fr] gap-8">
            {/* Brand column */}
            <div>
              <h3 className="text-xl font-serif font-semibold text-white mb-1">
                {v("brandName")}
              </h3>
              <p className="text-sm text-white/50 mb-3">{v("brandTagline")}</p>
            ...
            <div>
              ...
              <ul className="space-y-1.5 text-[0.9375rem] text-white/80">
                <li className="flex items-center gap-1.5 wrap-break-word">
                  ...
                  {v("contactEmail") || "Andre.Wikholm@WikholmOrt.com"}
                </li>
